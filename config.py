...
def config_grip():
    parser = argparse.ArgumentParser(prog="CISDL_video")
    parser.add_argument("--dataset", type=str, default="grip")
    parser.add_argument(
        "--size", type=str, default="320x320", help="image shape (h x w)"
    )
    parser.add_argument("--num", type=int, default=10)
...
def config_world():
    parser = argparse.ArgumentParser(prog="CISDL")
    parser.add_argument("--dataset", type=str, default="world_journal")
    ...
    # path config
    parser.add_argument(
        "--root", type=str, default=HOME + "/dataset/video_forge/world_journal_data"
    )
    parser.add_argument("--out-channel", type=int, default=1)
    parser.add_argument("--gamma", type=float, default=0.1)
    parser.add_argument("--gamma2", type=float, default=1e-5)
