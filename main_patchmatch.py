...
import config
import models
from train import train_patchmatch

from test import test_patchmatch
import dataset
...
if __name__ == "__main__":
    ...
    if args.test:
        with torch.no_grad():
            for i, ret in enumerate(data_test.load_template()):
                X1, X2, *_ = ret
    ...
    data_train = dataset.Dataset_COCO_CISDL(args, mode=None, is_training=True, fore_only=True)
