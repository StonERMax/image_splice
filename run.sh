...
python main.py --test --ckpt ./ckpt/base_coco_exp_new_with_flip.pkl --num 100 --plot | tee log_out/base_coco.txt
...
python main.py --test  --num 100 --plot --model dmac | tee log_out/dmac_coco.txt
...
python main.py --test  --num 100 --plot --model dmvn | tee log_out/dmvn_coco.txt
