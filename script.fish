...
python main_cmfd.py --mode mani --max-iter 1000  --batch-size 20 --tune --ckpt ./ckpt_cmfd/cmfd_usc_both_direct.pkl
python main_cmfd.py --mode mani --max-iter 10000 --lr 1e-5 --batch-size 20 --ckpt ./ckpt_cmfd/cmfd_usc_mani.pkl
